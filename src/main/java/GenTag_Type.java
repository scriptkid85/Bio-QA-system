...
/** 
 * Updated by JCasGen Tue Oct 16 00:39:49 CST 2012
 * @generated */
public class GenTag_Type extends Annotation_Type {
  ...
  public GenTag_Type(JCas jcas, Type casType) {
    ...
    casFeat_Lineindex = jcas.getRequiredFeatureDE(casType, "Lineindex", "uima.cas.String", featOkTst);
    casFeatCode_Lineindex  = (null == casFeat_Lineindex) ? JCas.INVALID_FEATURE_CODE : ((FeatureImpl)casFeat_Lineindex).getCode();

 
    casFeat_mSofa = jcas.getRequiredFeatureDE(casType, "mSofa", "uima.cas.String", featOkTst);
    casFeatCode_mSofa  = (null == casFeat_mSofa) ? JCas.INVALID_FEATURE_CODE : ((FeatureImpl)casFeat_mSofa).getCode();
